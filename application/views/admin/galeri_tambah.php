		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="box">
					...
					<div class="box-body">
						<?php echo form_open('admin/dasbor/galeri_add/', 'role="form"'); ?>

						<div class="box-body">
							<div class="form-group">
								<label>Gambar</label>
								<div class="input-group input-group-sm">
									<input type="text" id="as" name="gambar" class="form-control">
							...
							<div class="form-group">
								...
								<select class="form-control" name="kategori">
									...
									<?php foreach ($kategori  as $row) { ?>
										<option value="<?php echo $row['id'] ?>" <?php echo set_select('kategori', $row['k_galeri']); ?>>
											<?php echo $row['k_galeri'] ?></option>
									<?php } ?>
								</select>
							</div>
							<div class="form-group">
