            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <?php echo form_open('admin/dasbor/slide_update/'.$row['id'],'role="form"');?>

                    <div class="box-body">
                      <div class="form-group">
                        <label>Nama</label>
                        <?php echo form_input('name',$row['name'],'class="form-control" placeholder="Nama"');?>
                      </div>
                      <div class="form-group">
                        <label>Deskripsi</label>
                        <textarea class="form-control" rows="3" name="description" placeholder="Deskripsi"><?php echo $row['description']?></textarea>
                      ...
                      <div class="input-group input-group-sm">
                        <input type="text" id="as" name="image" value="<?php echo $row['image']; ?>" class="form-control">
                      ...
                      <div class="form-group">
                        <img src="<?php echo $row['image']; ?>" id="prev_img" class="img-fluid" style="width: 50%;">
